...
export const GovernmentView: React.FC<GovernmentViewProps> = ({ onOpenSource }) => {
  const { villageHead, officials } = useVillageData();
      ...
      <div className="bg-gradient-to-r from-emerald-950 via-slate-900 to-slate-900 text-white rounded-3xl p-8 sm:p-10 shadow-xl relative overflow-hidden">
        <div className="max-w-3xl space-y-3 relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
            Struktur Pemerintahan Desa Brabo
          </h1>
          <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
            Struktur kepemimpinan, Kepala Desa definitif, Sekretariat Desa, Pelaksana Teknis Seksi, Pelaksana Kewilayahan Kepala Dusun, dan pamong desa terkelola secara dinamis dan transparan.
          </p>
        </div>
      </div>
